...
<div class="white-frame" style="overflow: auto;">
	...
	<h4><s:message code="task.state" />:	<t:state state="${task.state}"/></h4>
	<hr>
	${task.description}
	<hr>
	...
	<button class="btn btn-default btn-sm" data-toggle="modal"
		...
		<span class="glyphicon glyphicon-list-alt"></span> <s:message code="task.changeState" />
	</button>
	
	<!-- Button trigger modal -->
	<button class="btn btn-default btn-sm" data-toggle="modal"
		data-target="#logWork">
		<span class="glyphicon glyphicon-time"></span> <s:message code="task.logWork"></s:message>
	</button>
	<%--ESTIMATES TAB --%>
	...
	<table style="width: 400px">
		<tr>
			<td class="bar_td" style="width: 50px"><s:message code="task.estimate"/></td>
		...
		<tr>
			...
			<td><div class="progress">
					<div class="progress-bar progress-bar-success" role="progressbar"
						aria-valuenow="${task.percentage_left}" aria-valuemin="0" aria-valuemax="100"
	...
	<ul class="nav nav-tabs">
		<li class="active"><a href="#"><s:message code="task.activeLog"/></a></li>
	</ul>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel"><s:message code="task.logWork"/></h4>
			</div>
			<form id="mainForm" name="mainForm" method="post"
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<span class="help-block"><s:message code = "task.logWork.help"></s:message> </span>
					</div>

				</div>
				<div class="modal-footer">
					<button class="btn btn-default" type="submit"><s:message code ="main.log"/></button>
					<a class="btn" data-dismiss="modal"><s:message code="main.cancel"/></a>
				</div>
			</form>
		</div>
	</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal"
					aria-hidden="true">&times;</button>
				<h4 class="modal-title" id="myModalLabel"><s:message code="task.changeState" /></h4>
			</div>
			<form id="mainForm" name="mainForm" method="post"
				...
				<div class="modal-footer">
					<button class="btn btn-default" type="submit"><s:message code ="main.change"/></button>
					<a class="btn" data-dismiss="modal"><s:message code="main.cancel"/></a>
				</div>
			</form>
		</div>
