        ...
        <div>
            ...
            <ul class="nav nav-tabs">
                ...
                <li id="comments-tab" class="active"><a style="color: black" href="#comments"
                                                        data-toggle="tab"><i class="fa fa-comments"></i> Comments</a>
                </li>
            </ul>
            <div id="myTabContent" class="tab-content">
                <div id="comments" class="tab-pane fade in active">
                    <table class="table table-hover button-table">
                        ...
                        <th></th>
                        <th id="sorter" class="time-header clickable"><span id="indicator"><i
                                class="fa fa-caret-down"></i></span>&nbsp;Date
                        </th>
                        </thead>
                ...
                <div class="modal-body">
                    ...
                    <div class="checkbox">
                        ...
                        <label class="checkbox"> <input type="checkbox"
                                                        name="zero_checkbox" id="modal_zero_checkbox"> Set remaining
                            time
                    ...
                    <div id="closeSubtask" class="checkbox" style="display:none">
                        ...
                        <label class="checkbox"> <input type="checkbox"
                                                        name="closesubtasks" id="modal_subtasks" checked>Close all
                            subtasks?
                        ...
                        <table style="width:100%;margin-top: 20px;">
							...
							<span id="assign_me_btn" class="btn btn-default" style="width:150px">
								<i class="fa fa-user"></i> Assign me</span>
                                    <button id="assign_btn" class="btn btn-default" disabled="disabled"
                                            style="width:150px">
